...
export const MessageBubble: React.FC<MessageBubbleProps> = ({ message, isLoading }) => {
  ...
  const markdownStyles = useMemo(() => ({
    ...
    code_inline: {
      ...
      color: theme.color12?.val || theme.color?.val || '#000',
      fontFamily: 'SF Mono, Monaco, Inconsolata, "Roboto Mono", Consolas, "Liberation Mono", Menlo, Courier, monospace',
      fontSize: 14,
      paddingHorizontal: 4,
      paddingVertical: 2,
      borderRadius: 4,
    ...
    hr: {
      backgroundColor: theme.borderColor?.val || theme.gray6?.val || '#e0e0e0',
      height: 1,
      marginVertical: 16,
    },
  }), [theme])
