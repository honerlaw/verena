...
export function PrivacyPolicyPage() {
  return (
    <ScrollView
      ...
      width="100%"
    >
      <H1 fontSize="$10" fontWeight="bold" color="$color" marginBottom="$4">
        Privacy Policy
      </H1>
      <Text fontSize="$4" color="$color075" marginBottom="$6">
        Last updated: September 21, 2025
      </Text>
      <Text fontSize="$5" color="$color" lineHeight="$6" marginBottom="$4">
        This Privacy Policy describes Our policies and procedures on the
        collection, use and disclosure of Your information when You use the
        Service and tells You about Your privacy rights and how the law protects
        You.
      </Text>
      <Text fontSize="$5" color="$color" lineHeight="$6" marginBottom="$8">
      ...
      <Text fontSize="$5" color="$color" lineHeight="$6" marginBottom="$6">
      ...
      <YStack gap="$3" marginBottom="$8">
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Account</Text> means a unique account
            created for You to access our Service or parts of our Service.
          </Text>
        </YStack>
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Affiliate</Text> means an entity that
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Application</Text> refers to Verena, the
            software program provided by the Company.
          </Text>
        </YStack>
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Company</Text> (referred to as either
            &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to Onerlaw LLC, 1001 Wade
            Ave Suite 327, Raleigh, NC 27605.
          </Text>
        </YStack>
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Country</Text> refers to: North Carolina,
            United States
          </Text>
        </YStack>
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Device</Text> means any device that can
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Personal Data</Text> is any information that
            relates to an identified or identifiable individual.
          </Text>
        </YStack>
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Service</Text> refers to the Application.
          </Text>
        </YStack>
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Service Provider</Text> means any natural or
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">Usage Data</Text> refers to data collected
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">You</Text> means the individual accessing or
      ...
      <YStack gap="$3" marginBottom="$6">
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">To provide and maintain our Service</Text>,
            including to monitor the usage of our Service.
          </Text>
        </YStack>
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">To manage Your Account:</Text> to manage
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">For the performance of a contract:</Text>{" "}
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">To contact You:</Text> To contact You by
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">To provide You</Text> with news, special
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">To manage Your requests:</Text> To attend
            and manage Your requests to Us.
          </Text>
        </YStack>
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">For business transfers:</Text> We may use
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">For other purposes</Text>: We may use Your
      ...
      <YStack gap="$3" marginBottom="$8">
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">With Service Providers:</Text> We may share
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">For business transfers:</Text> We may share
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">With Affiliates:</Text> We may share Your
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">With business partners:</Text> We may share
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">With other users:</Text> when You share
        ...
        <YStack>
          <Text fontSize="$5" color="$color" lineHeight="$6">
            <Text fontWeight="bold">With Your consent</Text>: We may disclose
      ...
      <YStack paddingLeft="$4" marginBottom="$8">
        <Text fontSize="$5" color="$color" lineHeight="$6">
          By email:{" "}
