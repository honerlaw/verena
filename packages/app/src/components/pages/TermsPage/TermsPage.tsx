  ...
  return (
    <ScrollView padding="$4">
      <YStack gap="$4">
        ...
        <Paragraph>Last updated: September 21, 2025</Paragraph>
        <Paragraph>
        ...
        <YStack gap="$2" paddingLeft="$4">
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>
              <Text fontWeight="bold">Application</Text> means the software
              program provided by the Company downloaded by You on any
              electronic device, named Verena
            </Paragraph>
          </XStack>
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>
              <Text fontWeight="bold">Application Store</Text> means the digital
          ...
          <XStack gap="$2">
            ...
            <Paragraph flex={1}>
              ...
              &quot;Our&quot; in this Agreement) refers to Onerlaw LLC, 1001
              Wade Ave Suite 327 Raleigh, NC 27605.
            </Paragraph>
          </XStack>
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>
              <Text fontWeight="bold">Content</Text> refers to content such as
          ...
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>
              <Text fontWeight="bold">Feedback</Text> means feedback,
          ...
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>
              <Text fontWeight="bold">Terms and Conditions</Text> (also referred
              as &quot;Terms&quot;) mean these Terms and Conditions that form
          ...
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>
              <Text fontWeight="bold">Third-party Social Media Service</Text>{" "}
          ...
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>
              <Text fontWeight="bold">You</Text> means the individual accessing
        ...
        <YStack gap="$2" paddingLeft="$4">
          ...
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>False information and features.</Paragraph>
          </XStack>
        </YStack>
        <Paragraph>
          ...
          the use of the Service if You post such objectionable Content.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          our copyright agent via email at support@onerlaw.com and include in
        ...
        <Paragraph>
          You can contact our copyright agent via email at support@onerlaw.com.
        </Paragraph>
        <Paragraph>
        ...
        <YStack gap="$2" paddingLeft="$4">
          <XStack gap="$2">
            <Text>•</Text>
            <Paragraph flex={1}>By email: support@onerlaw.com</Paragraph>
          </XStack>
        </YStack>
      </YStack>
    </ScrollView>
